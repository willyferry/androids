...
class DataManageService : Service(), CoroutineScope {

    private val TAG = DataManageService::class.java.simpleName
        ...
        if(firstRun) {
            ...
            try {
                ...
                loop@ for(model in mahasiswaModels) {
                    ...
                    // Jika service atau activity dalam keadaan maka akan otomatis menghentikan perulangan
                    when {
                ...
                when {
                    job.isCancelled -> {
                        ...
                        mahasiswaHelper.setTransactionSucces()

...
class FavoriteTvShowAdapter : PagedListAdapter<MoviesEntity, FavoriteTvShowAdapter.FavoriteTvShowViewHolder>(DIFF_CALLBACK) {
    ...
    class FavoriteTvShowViewHolder (private val binding: ItemsCardBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteTvShowViewHolder {
        ...
        return FavoriteTvShowViewHolder(itemsCardBinding)
    }
